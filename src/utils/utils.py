# Copyright (c) aof_research. All rights reserved.
import pytz
import re
import random
import requests
...
def get_ind_class(
    ...
    :params:
        ...
        @english_name: str - part of the industry's English name to query for@english_name: str - part of the industry's English name to query for
    ...
    :example:
        ...
        START = '2024-12-01
        END = '2025-01-01'
        ind_df, meta = get_ind_class(code_list=["TCB", "ACB"])
...
if __name__ == "__main__":
    ...
    print(is_directory(r'/home/dev/Desktop/Work/NCKH2025'))
